...
public class BatchManager {
    ...
    public BatchManager(EventHubProducerClient producer, boolean forceSinglePartitionMode, String partitionID, String partitionKey, Integer maxBatchSize) {
    ...
    public void initializeBatch(List<ChangeEvent<Object, Object>> records, DebeziumEngine.RecordCommitter<ChangeEvent<Object, Object>> committer) {
